...
<body>
<form id="form1" name="form1" method="post" action="NewEmployeeRegister_code.jsp">
...
<table rules="none" width="974" border="1" align="center" cellpadding="4" cellspacing="4" >
  ...
  <tr>
    <td width="520" height="260" align="center" valign="top"><p>&nbsp;</p>
      <table width="553" border="1" cellspacing="11">
        <tr>
          <td colspan="2" align="center"><h1><em>New Employee Register </em></h1></td>
          </tr>
        <tr>
