        ...
        <table width="1314" border="1" align="center">
          <tr>
            ...
            <td width="125"><span class="style202">Location</span></td>
              <td width="125"><span class="style202">Photo</span></td>
                <td width="103" align="center"><span class="style202">You Bye</span></td>
          </tr>
...
String query="select * from productcategory where location='"+b+"'  or  productnm='"+a+"'";
...
<td width="103" align="center"><span style="font-size:12px"><a href="bookingproduct.jsp?value=<%=rs.getString(1)%>">Buye</a></span></td>
