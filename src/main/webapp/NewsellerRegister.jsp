...
<body>
<form id="form1" name="form1" method="post" action="NewsellerRegister_code.jsp">
...
<table rules="none" width="974" border="1" align="center" cellpadding="4" cellspacing="4" >
  ...
  <tr>
    <td width="520" height="260" align="center" valign="top"><p>&nbsp;</p>
      <table width="594" border="1" cellspacing="11">
        <tr>
          <td colspan="2" align="center"><h1><em>New Seller Registration</em></h1></td>
          </tr>
        <tr>
          <td width="207">User Name</td>
          <td width="344"><span id="sprytextfield1">
        ...
        <tr>
          <td height="37">Ad Booking Cost</td>
          <td><span id="sprytextfield6">
          <input name="t6" type="text" id="t6" value="1000" size="55" />
          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
        </tr>
        <tr>
          <td height="85">&nbsp;</td>
...
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "custom", {pattern:"xxxxxxxxxx"});
