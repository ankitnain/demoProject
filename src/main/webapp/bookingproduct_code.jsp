...
{
//==================================================amount cal==========================================================
ResultSet res1=st.executeQuery("select * from  productcatogray where productnm='"+f+"'");
...
String query="insert into bookingproduct values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"',"+g+",'"+h+"','"+i+"','"+j+"','"+k+"','"+l+"',"+totalcost+")";
